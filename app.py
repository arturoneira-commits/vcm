...
def aplicar_estilo_powerbi_bar(fig, titulo=""):
    fig.update_layout(
        ...
        xaxis=dict(showgrid=True, gridcolor="#E2E8F0", zeroline=False, title=None),
        yaxis=dict(showgrid=False, zeroline=False, title=None, autorange="reversed"),
        hoverlabel=dict(bgcolor="#0F172A", font_size=12, font_family="Segoe UI, sans-serif", font_color="#FFFFFF")
    )
    fig.update_traces(
        marker_color="#2563EB",
        marker_line_width=0,
